...
Toc.products.FiltersPanel = function(config) {
  config = config || {};
  ...
  Toc.products.FiltersPanel.superclass.constructor.call(this, config);
};

Ext.extend(Toc.products.FiltersPanel, Ext.grid.GridPanel, {
