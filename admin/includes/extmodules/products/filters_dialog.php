...
Toc.products.FiltersDialog = function(config) {
  config = config || {};
  
  config.id = 'filters_dialog-win';
  ...
  Toc.products.FiltersDialog.superclass.constructor.call(this, config);
}

Ext.extend(Toc.products.FiltersDialog, Ext.Window, {
  buildForm: function() {
