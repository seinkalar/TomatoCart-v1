...
?>
Toc.store.HomepageInfoPanel = function (config) {
  config = config || {};
  
  config.title = '<?php echo $osC_Language->get('section_homepage_info'); ?>';
  config.border = false;
  config.layout = 'fit';

  config.items = this.buildForm();

  Toc.store.HomepageInfoPanel.superclass.constructor.call(this, config);
};

Ext.extend(Toc.store.HomepageInfoPanel, Ext.Panel, {
  buildForm: function () {
