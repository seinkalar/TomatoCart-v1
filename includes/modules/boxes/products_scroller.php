  ...
  class osC_Boxes_products_scroller extends osC_Modules {
    ...
    function initialize() {
      ...
      if (MODULE_BOX_PRODUCTS_SCROLLER_PRODUCTS_TYPE == 'New Products') {
        ...
        $Qproducts = $osC_Database->query('select p.products_id, p.products_tax_class_id, p.products_price, pd.products_name, i.image from :table_products p, :table_products_to_stores p2s, :table_products_images i, :table_products_description pd where p.products_status = 1 and p.products_id = pd.products_id and p.products_id = i.products_id and i.default_flag = :default_flag and pd.language_id = :language_id and p.products_id = p2s.products_id and p2s.stores_id = :stores_id order by p.products_date_added desc limit :max_display_products');
        ...
        $Qproducts = $osC_Database->query('select p.products_id, p.products_tax_class_id, p.products_price, pd.products_name, i.image, s.specials_new_products_price from :table_products p, :table_products_to_stores p2s, :table_products_images i, :table_products_description pd, :table_specials s where s.status = 1 and s.products_id = p.products_id and p.products_status = 1 and p.products_id = pd.products_id and p.products_id = i.products_id and i.default_flag = :default_flag and pd.language_id = :language_id and p.products_id = p2s.products_id and p2s.stores_id = :stores_id order by s.specials_date_added desc limit :max_display_products');
        ...
        $Qproducts = $osC_Database->query('select p.products_id, p.products_tax_class_id, p.products_price, pd.products_name, i.image from :table_products p, :table_products_images i, :table_products_description pd, :table_products_to_stores p2s where p.products_status = 1 and p.products_id = pd.products_id and p.products_id = i.products_id and i.default_flag = :default_flag and pd.language_id = :language_id and p.products_ordered > 0 and p.products_id = p2s.products_id and p2s.stores_id = :stores_id order by p.products_ordered desc limit :max_display_products');
      }
