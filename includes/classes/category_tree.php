...
*/
  ...
  class osC_CategoryTree {
    ...
    function calculateCategoryProductCount() {
      ...
      $Qtotals = $osC_Database->query('select p2c.categories_id, count(*) as total from :table_products p, :table_products_to_categories p2c, :table_products_to_stores p2s where p2c.products_id = p.products_id and p2s.products_id = p.products_id and p2s.stores_id = :stores_id and p.products_status = :products_status group by p2c.categories_id');
      ...
      $Qtotals->bindTable(':table_products_to_stores', TABLE_PRODUCTS_TO_STORES);
