<?php
/*
 * $Id: template.php $ TomatoCart Open Source Shopping Cart Solutions http://www.tomatocart.com Copyright (c) 2009 Wuxi Elootec Technology Co., Ltd; Copyright (c) 2005 osCommerce This program is free software; you can redistribute it and/or modify it under the terms of the GNU General Public License v2 (1991) as published by the Free Software Foundation.
 */
...
class osC_Template {
	...
	/**
	 * Holds the rel=”canonical” link to remove the duplication content such products, categoroes and articles
	 *
	 * @var string
	 * @access public
	 */
	 ...
	 * @access private
	 */
	var $_javascript_filenames = array (
			'includes/general.js' 
	);
	 ...
	 *
	 * @param string $module
	 *        	The default page module to setup
	 * @return object
	 */
	 ...
	 * @param string $group
	 *        	The group name of moudle such as boxes, content, payment etc
	 * @return bool
	 */
	 ...
	 *
	 * @param string $group
	 *        	The group name of box modules to include that the template has provided
	 * @return array
	 */
	 ...
	 *
	 * @param string $group
	 *        	The group name of content modules to include that the template has provided
	 * @return array
	 */
	 ...
	 *
	 * @param string $title
	 *        	The title of the page to set to
	 * @access public
	 */
	 ...
	 *
	 * @param string $image
	 *        	The image of the page to set to
	 * @access public
	 */
	 ...
	 *        	The content filename to include on the page
	 * @access public
	 */
	 ...
	 *
	 * @param string $key
	 *        	The keyword for the meta tag
	 * @param string $value
	 *        	The value for the meta tag using the key
	 * @access public
	 */
	 ...
	 *
	 * @param string $filename
	 *        	The javascript filename to link to
	 * @access public
	 */
	 ...
	 *
	 * @param string $filename
	 *        	The PHP based javascript filename to embedd
	 * @access public
	 */
	 ...
	 *        	The javascript block to add on the page
	 * @access public
	 */
	 ...
	 *
	 * @param string $javascript
	 *        	The javascript block to add on the head of the page
	 * @access public
	 */
	...
	/**
	 * Using rel=”canonical” links to remove the duplication content such as products, categories and articles
	 *
	 * @access public
	 * @param string $seo_link
	 * @return void
	 */
	function add_canonical($seo_link) {
		global $request_type;
		...
		$this->rel_canonical = '<link rel="canonical" href="' . $link_prefix . $seo_link . '"/>';
	}
}
